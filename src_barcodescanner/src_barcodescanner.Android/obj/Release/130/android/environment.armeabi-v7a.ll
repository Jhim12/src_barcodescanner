...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"8dd82b1f-2fce-4a82-a3ae-4566f5d0e340\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [35 x i8] c"com.companyname.src_barcodescanner\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 110, ; number_of_assemblies_in_apk
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [110 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
